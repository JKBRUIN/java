...
public class Kellam_320Discuss10 {
  public static void main(String [] args){
     ...
     for(int i = 0; i < 100; ++i){
          ...
          list.add(intObject);
          set.add(intObject);
          System.out.println("Iteration " + (i + 1) + ": Integer " + intObject + " added to List and if unique, added to Set."); // added to see the program at work, because I keep getting List=100 and Set=10
     }
